...
var myVar2;             // 암시적으로 undefinde 대입 된다.
...
console.log("2" === 2);                             // false => (타입의 동일성)
console.log(true === 1);                            // false => (타입의 동일성)
console.log(4 === 2);                               // false => (값의 동일성)
console.log(new Number(4) === new Number(4));       // false => (객체의 동일성)
